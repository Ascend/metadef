...
if [[ "X$ENABLE_METADEF_UT" = "Xon" || "X$ENABLE_METADEF_COV" = "Xon" ]]; then
    ...
    rm -rf ${BASEPATH}/cov
    mkdir ${BASEPATH}/cov
    lcov -c -d build/tests/ut/graph -d build/tests/ut/register -d build/graph/CMakeFiles/graph_static.dir -d build/register/CMakeFiles/register_static.dir/ -o cov/coverage.info
    cd ${BASEPATH}/cov
