...
class ScopeBasePass::ScopeBasePassImpl {
 ...
 private:
  ...
  static bool MatchOneScope(const ScopePattern *pattern, Scope *scope, std::vector<Scope *> &results);
  static Status PrintFusionScopeInfo(std::shared_ptr<ScopeGraph> &scope_graph);
