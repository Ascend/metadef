...
class HcomTopoInfo {
 public:
  ...
  Status SetGroupTopoInfo(const std::string &group, const TopoInfo &info);
  Status GetGroupRankSize(const std::string &group, int64_t &rank_size);
  void UnsetGroupTopoInfo(const std::string &group) {
