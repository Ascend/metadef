...
class NodeUtils {
 public:
  ...
  ///          If it is called like GetInNodeCrossPartionCallNode(B,0,rNode) or(Data1, 0, rNode), rNode will be A
  /// @return [graphStatus] running result of this function
  ///
  static graphStatus GetInNodeCrossPartionCallNode(const NodePtr &node, uint32_t index, NodePtr &rNode);
