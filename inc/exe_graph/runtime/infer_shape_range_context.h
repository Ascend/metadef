...
class InferShapeRangeContext : public ExtendedKernelContext {
 public:
   ...
   */
  const ShapeRange *GetInputShapeRange(size_t index) const {
    return GetInputPointer<ShapeRange>(index);
  }
  /**
   ...
   */
  const TensorRange *GetInputTensorRange(size_t index) const {
   ...
   */
  const TensorRange *GetOptionalInputTensorRange(size_t ir_index) const {
   ...
   */
  const TensorRange *GetDynamicInputTensorRange(size_t ir_index, size_t relative_index) const {
   ...
   */
  const ShapeRange *GetOptionalInputShapeRange(size_t ir_index) const {
    return GetDynamicInputPointer<ShapeRange>(ir_index, 0);
  }
  /**
   ...
   */
  const ShapeRange *GetDynamicInputShapeRange(size_t ir_index, size_t relative_index) const {
    return GetDynamicInputPointer<ShapeRange>(ir_index, relative_index);
  }
   ...
   */
  ShapeRange *GetOutputShapeRange(size_t index) {
    return GetOutputPointer<ShapeRange>(index);
  }
};
