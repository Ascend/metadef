...
#define GE_CHECK_NOTNULL(val)                                                               \
  do {                                                                                      \
    if (val == nullptr) {                                                                   \
      GELOGE(ge::GRAPH_PARAM_INVALID, "[Check][Param] param[%s] must not be null.", #val);  \
      return ge::GRAPH_PARAM_INVALID;                                                       \
    }                                                                                       \
  } while (0)
...
#define GE_RT_FALSE_CHECK_NOTNULL(val)                                              \
  do {                                                                              \
    if (val == nullptr) {                                                           \
      GELOGE(ge::GRAPH_FAILED, "[Check][Param] param[%s] must not be null.", #val); \
      return false;                                                                 \
    }                                                                               \
  } while (0)
...
#define GE_CHECK_SIZE(size)                                                                \
  do {                                                                                     \
    if (size == 0) {                                                                       \
      GELOGE(ge::GRAPH_PARAM_INVALID, "[Check][Param] param[%s] is out of range", #size);  \
      return ge::GRAPH_PARAM_INVALID;                                                      \
    }                                                                                      \
  } while (0)
...
#define GE_DEFINE_BYTE_SIZE(_var_name, _expr, _sizeof)                                                \
  ...
  do {                                                                                                \
    ...
    if (_expr_size > (0xffffffff) / _sizeof_size) {                                                   \
      GELOGE(ge::GRAPH_PARAM_INVALID, "[Check][Param] byte size : %s is out of range", #_var_name);   \
      return ge::GRAPH_PARAM_INVALID;                                                                 \
    }                                                                                                 \
...
#define GE_CHECK_VECTOR_NOT_EMPTY(vector)                                             \
  do {                                                                                \
    if (vector.empty()) {                                                             \
      GELOGE(ge::GRAPH_FAILED, "[Check][Param] param[#vector] is empty", #vector);    \
      return ge::GRAPH_FAILED;                                                        \
    }                                                                                 \
  } while (0)
...
#define GE_CHECK_VECTOR_NOT_EMPTY_RET_STATUS(vector, _status)           \
  do {                                                                  \
    if (vector.empty()) {                                               \
      GELOGE(_status, "[Check][Param] param[%s] is empty", #vector);    \
      return _status;                                                   \
    }                                                                   \
  } while (0)
...
#define GE_CHECK_POSITIVE_SIZE_RANGE(size)                                                           \
  do {                                                                                               \
    if (size <= 0) {                                                                                 \
      GELOGE(ge::GRAPH_PARAM_INVALID, "[Check][Param] param[%s] is not a positive number", #size);   \
      return ge::GRAPH_PARAM_INVALID;                                                                \
    }                                                                                                \
  } while (0)
...
#define GE_CHECK_GE(lhs, rhs)                                                                   \
  do {                                                                                          \
    if (lhs < rhs) {                                                                            \
      GELOGE(ge::GRAPH_PARAM_INVALID, "[Check][Param] param[%s] is less than[%s]", #lhs, #rhs); \
      return ge::GRAPH_PARAM_INVALID;                                                           \
    }                                                                                           \
  } while (0)
...
#define GE_CHECK_EQ(val1, val2)                                                                        \
  do {                                                                                                 \
    if (val1 != val2) {                                                                                \
      GELOGE(ge::GRAPH_PARAM_INVALID, "[Check][Param] param[%s] is not equals to[%s]", #val1, #val2);  \
      return ge::GRAPH_PARAM_INVALID;                                                                  \
    }                                                                                                  \
  } while (0)
...
#define GE_CHECK_LE(lhs, rhs)                                                                         \
  do {                                                                                                \
    if (lhs > rhs) {                                                                                  \
      GELOGE(ge::GRAPH_PARAM_INVALID, "[Check][Param] param[%s] is greater than[%s]", #lhs, #rhs);    \
      return ge::GRAPH_PARAM_INVALID;                                                                 \
    }                                                                                                 \
  } while (0)
