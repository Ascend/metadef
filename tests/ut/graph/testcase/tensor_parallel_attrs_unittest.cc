      ...
      R"(
{
  ...
  ShardGraphExtAttrs shard_graph_ext_attrs;
  ASSERT_EQ(TensorParallelAttrs::FromJson(json_str, shard_graph_ext_attrs), SUCCESS);
  const auto str = TensorParallelAttrs::ToJson(shard_graph_ext_attrs);
  ShardGraphExtAttrs shard_graph_ext_attrs_from_json;
  ASSERT_EQ(TensorParallelAttrs::FromJson(str, shard_graph_ext_attrs_from_json), SUCCESS);
  EXPECT_EQ(shard_graph_ext_attrs_from_json.graph_name_to_endpoints, shard_graph_ext_attrs.graph_name_to_endpoints);
  EXPECT_EQ(shard_graph_ext_attrs_from_json.dev_index_to_logic_dev_id,
            shard_graph_ext_attrs.dev_index_to_logic_dev_id);
  EXPECT_EQ(shard_graph_ext_attrs_from_json.group_name_to_dev_ids, shard_graph_ext_attrs.group_name_to_dev_ids);
}
