...
TEST_F(ValueHolderUt, NormalGuard_AddFlagToNode) {
  auto data0 = ValueHolder::CreateFeed(0);
  auto allocator0 = ValueHolder::CreateSingleDataOutput("CreateAllocator", {data0});
  auto allocator_destroyer = ValueHolder::CreateSingleDataOutputGuarder("DestroyAllocator", allocator0, {});
  ASSERT_NE(allocator_destroyer, nullptr);
  auto graph = ValueHolder::PopGraphFrame()->GetExeGraph();
...
TEST_F(ValueHolderUt, NormalGuarder_AddDependencyAutomately_ConnectDataEdgeToResource) {
  auto data0 = ValueHolder::CreateFeed(0);
  auto allocator0 = ValueHolder::CreateSingleDataOutput("CreateAllocator", {data0});
  auto allocator_destroyer = ValueHolder::CreateSingleDataOutputGuarder("DestroyAllocator", allocator0, {});
  ASSERT_NE(allocator_destroyer, nullptr);
...
*        data0
*/
TEST_F(ValueHolderUt, NormalGuarder_AddDependencyFromTheSameLevelNode_ConnectFromSrcToSubgraphNodes) {
  auto data0 = ValueHolder::CreateFeed(0);
  auto foo0 = ValueHolder::CreateSingleDataOutput("Foo", {data0});
  auto guarder = ValueHolder::CreateSingleDataOutputGuarder("FooGuarder", foo0, {});
  ASSERT_NE(guarder, nullptr);
  auto data1 = ValueHolder::CreateFeed(1);
  auto bar1 = ValueHolder::CreateSingleDataOutput("Bar", {data1});
...
TEST_F(ValueHolderUt, NormalGuarder_DoNotAddDependency_ConnectDataEdgeToNetOutput) {
  auto data0 = ValueHolder::CreateFeed(0);
  auto foo0 = ValueHolder::CreateSingleDataOutput("Foo", {data0});
  auto guarder = ValueHolder::CreateSingleDataOutputGuarder("FooGuarder", foo0, {});
  ASSERT_NE(guarder, nullptr);
...
TEST_F(ValueHolderUt, NormalAddDependencyForGuard_RleaseBy) {
  auto data0 = ValueHolder::CreateFeed(0);
  auto allocator0 = ValueHolder::CreateSingleDataOutput("CreateAllocator", {data0});
  auto allocator_destroyer = ValueHolder::CreateSingleDataOutputGuarder("DestroyAllocator", allocator0, {});
  ASSERT_NE(allocator_destroyer, nullptr);
  ...
  auto size = ValueHolder::CreateConst(&alloc_size, sizeof(alloc_size));
  auto alloc_mem0 = ValueHolder::CreateSingleDataOutput("AllocMemory", {allocator0, size});
  auto free_mem0 = ValueHolder::CreateSingleDataOutputGuarder("FreeMemory", {alloc_mem0}, {});
  auto graph = ValueHolder::PopGraphFrame()->GetExeGraph();
  CheckGraphGenerally(*graph);
